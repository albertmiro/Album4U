...
public class AppInjector {
    ...
    public static void init(AlbumsApp albumsApp) {
        DaggerAppComponent.builder()
                .application(albumsApp)
                .build()
                .inject(albumsApp);

        albumsApp.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
                    @Override
